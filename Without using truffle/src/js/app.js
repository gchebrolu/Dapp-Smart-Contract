...
//Deployed Contract ABI
  PayRollContract = web3.eth.contract([{"constant":false,"inputs":[],"name":"executeTransactions","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[],"name":"loadAmount","outputs":[],"payable":true,"stateMutability":"payable","type":"function"},{"constant":false,"inputs":[{"name":"receiver","type":"address"},{"name":"amountInEth","type":"uint256"},{"name":"dayDD","type":"uint8"},{"name":"monthMM","type":"uint8"},{"name":"yearYYYY","type":"uint16"}],"name":"addPayee","outputs":[{"name":"success","type":"bool"}],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[],"name":"getPayees","outputs":[{"name":"","type":"address[]"},{"name":"","type":"uint256[]"},{"name":"","type":"uint8[]"},{"name":"","type":"uint8[]"},{"name":"","type":"uint16[]"},{"name":"","type":"bool[]"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"name":"","type":"uint256"}],"name":"employees","outputs":[{"name":"receiver","type":"address"},{"name":"amount","type":"uint256"},{"name":"dayDD","type":"uint8"},{"name":"monthMM","type":"uint8"},{"name":"yearYYYY","type":"uint16"},{"name":"isTransactionDone","type":"bool"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"name":"input","type":"address"}],"name":"checkBalance","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[],"name":"reqBalanceInEth","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"name":"transferTo","type":"address"},{"name":"value","type":"uint256"}],"name":"directTransfer","outputs":[],"payable":true,"stateMutability":"payable","type":"function"},{"constant":true,"inputs":[],"name":"owner","outputs":[{"name":"","type":"address"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[],"name":"availableBalanceInEth","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[],"name":"contractAddress","outputs":[{"name":"","type":"address"}],"payable":false,"stateMutability":"view","type":"function"},{"inputs":[],"payable":true,"stateMutability":"payable","type":"constructor"},{"payable":true,"stateMutability":"payable","type":"fallback"}]);

  //Deployed Contract Address
  PayRoll = PayRollContract.at('0xc43618555aafb8cb7c9d463bb4a91482d65edecb');
  console.log(PayRoll);
...
function AddPayeeOnClick() {
    ...
    PayRoll.addPayee(toAddress, amount, day, month, year, (err, res) => {
        if (err) {
            $("#loader").hide();
            console.log(error);
        }
...
function ShowPayeeOnClick(){
    ...
    PayRoll.getPayees(function(error, result){
      if(!error)
        ...
        $("#payeeListTable").append('<tr><th>To Address</th><th>Amount in eth</th><th id="dateCol" class="tdh" onclick="sorter(this, 2, true);">Date(mm/dd/yyyy)</th><th>IsDone</th></tr>');

            for(var i=0; i<arrayLength; i++ ){
                $("#payeeListTable").append('<tr><td>' + result[0][i] + '</td>' + '' + '<td>' + result[1][i]/1000000000000000000 + '</td>' + '  '+ '<td>' + result[3][i] + '/' + result[2][i] + '/' + result[4][i] + '</td>' + '  '+ '<td>' + result[5][i] + '</td>' + '</tr>');
            }
...
function InstantTransferOnClick() {
    ...
    PayRoll.directTransfer(address, amount, {from: web3.eth.defaultAccount, value: web3.toWei(amount,  'ether')},function(error, result){
    if(!error)
        {
            $("#loader").hide();
            location = location;
